...
export function useOneSignal() {
  ...
  useEffect(() => {
    ...
    // Evitar inicializações duplicadas (StrictMode / re-montagens)
    if (!window.__onesignalScriptAdded) {
    ...
    // Configurar OneSignal quando carregado (somente uma vez)
    ...
    // Sem cleanup para não desmontar o SDK entre rotas
  }, [user?.id]);
}
